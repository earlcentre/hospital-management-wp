...
if(empty(get_option('hmgt_virtual_appointment_access_token')) OR get_option('hmgt_virtual_appointment_access_token'))
{
    ...
    $site_url=site_url().'/wp-admin/admin.php?page=hmgt_virtual_appointment&tab=meeting_list&message=4';
...
{
    $get_token = get_option('hmgt_virtual_appointment_access_token');
