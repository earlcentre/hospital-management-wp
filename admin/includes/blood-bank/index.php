												...
												<tbody>
												 <?php foreach($obj_bloodbank->MJ_hmgt_get_all_bloodgroups() as $retrieved_data){  ?>
													<tr>
														...
														<td class="action"> <a href="?page=hmgt_bloodbank&tab=addbloodgroop&&action=edit&bloodgroup_id=<?php echo esc_attr($retrieved_data->blood_id);?>" class="btn btn-info"> <?php esc_html_e('Edit', 'hospital_mgt' ) ;?></a>
