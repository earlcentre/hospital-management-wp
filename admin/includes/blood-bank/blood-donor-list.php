						...
						if(!empty($blooddonordata))
						{
							...
							<tr>
							  ...
							  <td class="lastdonate_date"><?php if(!empty($retrieved_data-> last_donet_date!='0000-00-00')) { echo date(MJ_hmgt_date_formate(),strtotime($retrieved_data-> last_donet_date)); }else{ echo '-'; } ?></td>
								<td class="action"> 
								<a href="#" class="view_details_popup btn btn-default" id="<?php echo esc_attr( $retrieved_data->bld_donor_id); ?>" type="<?php echo 'view_blooddonor';?>"><i class="fa fa-eye"> </i> <?php esc_html_e('View', 'hospital_mgt' ) ;?> </a>
