	...
	if(isset($_REQUEST['pharmacist_id']))
		...
		<div class="panel-body"><!--panel BODY DIV START-->	      
			<form name="pharmacist_form" action="" method="post" class="form-horizontal" id="pharmacist_form">
								 ...
								 <?php if($edit) 
									{
										...
										{?>
											<img class="image_preview_css" alt="" src="<?php echo esc_url( get_option( 'hmgt_pharmacist_thumb' )) ?>">
											<?php
										}
										else
										{?>
				...
				<div class="offset-sm-2 col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<input type="submit" value="<?php if($edit){ esc_html_e('Save Pharmacist','hospital_mgt'); }else{ esc_html_e('Save Pharmacist','hospital_mgt');}?>" name="save_pharmacist" class="btn btn-success"/>
				</div>
			</form>
