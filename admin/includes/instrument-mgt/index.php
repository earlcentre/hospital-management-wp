		...
		<div class="row"><!-- ROW DIV START -->
			<div class="col-md-12">
				<div class="panel panel-white"><!-- PANE WHITE DIV START -->
					<div class="panel-body nav_tab_responsive_4_tab"><!-- PANEL BODY DIV START -->
										...
										<table id="instrument_list" class="display" cellspacing="0" width="100%">
											...
											?>
												<tr>
													...
													<td class="action"> 
													<a href="#" class="view_details_popup btn btn-default" id="<?php echo esc_attr( $retrieved_data->id); ?>" type="<?php echo 'view_instrument';?>"><i class="fa fa-eye"> </i> <?php esc_html_e('View', 'hospital_mgt' ) ;?> </a>
