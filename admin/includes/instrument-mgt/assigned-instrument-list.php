				...
				<table id="instrument_list" class="display" cellspacing="0" width="100%">
					...
					?>		
								<tr>
									...
									<td class="action"> 
									<a href="#" class="view_details_popup btn btn-default" id="<?php echo esc_attr( $retrieved_data->id); ?>" type="<?php echo 'assigned_instrument';?>"><i class="fa fa-eye"> </i> <?php esc_html_e('View', 'hospital_mgt' ) ;?> </a>
