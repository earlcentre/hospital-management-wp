		...
		?>
			...
			<div class="form-group">
				<div class="mb-3 row">
					...
					<div class="col-sm-2">
						<input id="" class="form-control validate[custom[popup_category_validation]] text-input edit_med_uniqueid" maxlength="20" type="text" placeholder="<?php esc_html_e('Medicine ID','hospital_mgt');?>"	value="<?php if($edit){ echo esc_attr($result->med_uniqueid);}elseif(isset($_POST['med_uniqueid'])) echo esc_attr($_POST['med_uniqueid']);?>" name="med_uniqueid">
					</div>
				</div>				
			</div>	
			<div class="form-group">	
				...
				<div class="medicine_div">
					...
					<div class="form-group">
						<div class="mb-3 row">
							...
							<div class="col-sm-2 margin_bottom_5px">
								<input id="" class="form-control validate[custom[popup_category_validation]] text-input med_uniqueid" maxlength="20" type="text" placeholder="<?php esc_html_e('Medicine ID','hospital_mgt');?>"	value="" name="med_uniqueid[]">
							</div>
						</div>													
					</div>
					<div class="form-group">
