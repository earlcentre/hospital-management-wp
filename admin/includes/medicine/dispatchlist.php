				...
				<tbody>
					...
					if(!empty($medicinedata))
					{
						...
						<tr>
							...
							<td class="action"> <a href="?page=hmgt_medicine&tab=dispatch-medicine&&action=edit&dispatch_id=<?php echo esc_attr($retrieved_data->id);?>" class="btn btn-info"> <?php esc_html_e('Edit', 'hospital_mgt' ) ;?></a>
