...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		?>
			...
			$('#doctor_form_outpatient_popup_form_percription').validationEngine({
				promptPosition: "bottomLeft",
				maxErrorsPerField: 1
			});
			$('#doctor_form_popup_add_percription').validationEngine({
				promptPosition: "bottomLeft",
				maxErrorsPerField: 1
			});
		<?php
		...
		$('#report_type').multiselect({
			nonSelectedText: '<?php esc_html_e('SelectRequest Name', 'hospital_mgt'); ?>',
...
<div class="panel-body"><!-- panel body div start-->
	<form name="prescription_form" action="" method="post" class="form-horizontal" id="prescription_form">
		...
		<div class="form-group">
			<div class="mb-3 row">
				...
				<div class="col-sm-8">
					...
					} elseif (isset($_POST['prescription_type'])) {
					...
					<label class="radio-inline">
						<input type="radio" value="report" class="tog" name="prescription_type" <?php checked('report', $prescription_type);  ?> /><?php esc_html_e('Lab Request', 'hospital_mgt'); ?>
					</label>
				</div>
			</div>
		</div>
		<div id="tretment_div">
			<div class="form-group">
				<div class="mb-3 row">
					...
					<?php if ($edit) {
						$treatmentval = $result->teratment_id;
					} elseif (isset($_POST['treatment_id'])) {
						$treatmentval = $_POST['treatment_id'];
					} else {
						$treatmentval = "";
					} ?>
					<div class="col-sm-8">
			...
			<div class="form-group">
				<div class="mb-3 row">
					...
					<div class="col-sm-8">
						<textarea id="case_history" maxlength="150" class="form-control validate[required,custom[address_description_validation]]" name="case_history"><?php if ($edit) {
																																											echo esc_textarea($result->case_history);
																																										} elseif (isset($_POST['case_history'])) echo esc_textarea($_POST['case_history']); ?></textarea>
					</div>
				</div>
			</div>
			<?php
			...
			<div class="form-group">
				<div class="mb-3 row">
					...
					<div class="col-sm-8">
						<textarea id="note" class="form-control validate[custom[address_description_validation]]" maxlength="150" name="note"><?php if ($edit) {
																																					echo esc_textarea($result->treatment_note);
																																				} elseif (isset($_POST['note'])) echo esc_textarea($_POST['note']); ?> </textarea>
					</div>
				</div>
			</div>
			<?php
			...
			<div class="form-group">
				<div class="mb-3 row">
					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 has-feedback">
						...
						<input type="hidden" name="hidden_esami_image" class="form-control input-file" value="<?php if ($edit) {
																													echo $result->attach;
																												} ?>" />
		...
		<div id="prescription_report_div">
			<div class="form-group">
				<div class="mb-3 row">
					<label class="col-sm-2 control-label form-label" for="patient"><?php esc_html_e('Lab Request Type', 'hospital_mgt'); ?><span class="require-field">*</span></label>
					<div class="col-sm-8 multiselect_validation_Report margin_bottom_5px">
						<select class="form-control reportlist_list report_type" multiple="multiple" name="report_type[]" id="report_type">
							...
							?>
									<option value="<?php echo esc_attr($retrive_data->ID); ?>" <?php if (in_array($retrive_data->ID, $report_type)) {
																									echo 'selected';
																								} ?>><?php echo esc_html($report_type_array->category_name); ?></option>
							<?php
								}
							}
							?>
			...
			<div class="form-group">
				<div class="mb-3 row">
					...
					<div class="col-sm-8">
						<textarea id="" maxlength="150" class="form-control validate[required,custom[address_description_validation]]" name="report_description"><?php if ($edit) {
																																										echo esc_textarea($result->report_description);
																																									} elseif (isset($_POST['report_description'])) echo esc_textarea($_POST['report_description']); ?></textarea>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="mb-3 row">
					...
					<div class="col-sm-8">
						<div class="checkbox">
							<label>
								<input id="doctor_visiting_charge" type="checkbox" value="1" name="doctor_visiting_charge" <?php if ($edit) {
																																if ($result->doctor_visiting_charge == '1') {
																																	echo 'checked';
																																}
																															} ?>>
							</label>
			...
			<div class="form-group margin_bottom_5px">
				<div class="mb-3 row">
					...
					<div class="col-sm-8 margin_bottom_5px">
						<div class="checkbox">
							<label>
								<input id="doctor_consulting_charge" type="checkbox" value="1" name="doctor_consulting_charge" <?php if ($edit && $result->doctor_consulting_charge == '1') {
																																	echo 'checked';
																																} ?>>
							</label>
						</div>
		...
		<div class="offset-sm-2 col-lg-8 col-md-8 col-sm-8 col-xs-12 responsive_add_pescription_button_padding">
			<input type="submit" value="<?php if ($edit) {
											esc_html_e('Save', 'hospital_mgt');
										} else {
											esc_html_e('Save', 'hospital_mgt');
										} ?>" name="save_prescription" class="btn btn-success save_prescription" />
		</div>
	</form>
						...
						<form name="out_patient_form" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" class="form-horizontal" id="doctor_form_outpatient_popup_form_percription" enctype="multipart/form-data">
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="patient_id" class="form-control validate[required]" type="text" value="<?php echo esc_attr($newpatient); ?>" readonly name="patient_id">
									</div>
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input class="form-control validate[required] birth_date " type="text" name="birth_date" value="" readonly>
									</div>
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="city_name" class="form-control validate[required,custom[city_state_country_validation]]" type="text" maxlength="50" name="city_name" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 margin_bottom_5px">
										<input type="text" value="<?php if (isset($_POST['phonecode'])) {
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<!-- Adddoctor Button -->
									<div class="col-sm-2">
										<a href="#" class="btn btn-default" id="add_precription_doctor" data-toggle="modal" data-target="#myModal_add_doctor"> <?php esc_html_e('Add Doctor', 'hospital_mgt'); ?></a>
									</div>
								</div>
							</div>
							<div class="form-group">
						...
						<form name="doctor_form" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" class="form-horizontal" id="doctor_form" enctype="multipart/form-data">
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="" class="form-control validate[required,custom[address_description_validation]]" maxlength="150" type="text" name="office_address" value="">
									</div>
									<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="city_name"><?php esc_html_e('City', 'hospital_mgt'); ?><span class="require-field">*</span></label>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="" class="form-control validate[required,custom[city_state_country_validation]]" maxlength="50" type="text" name="city_name" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="mb-3 row">
									<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="state_name"><?php esc_html_e('State', 'hospital_mgt'); ?></label>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="" class="form-control validate[custom[city_state_country_validation]]" type="text" maxlength="50" name="state_name" value="">
									</div>
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="" class="form-control validate[custom[city_state_country_validation]]" maxlength="50" type="text" name="country_name" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="mb-3 row">
									<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="zip_code"><?php esc_html_e('Zip Code', 'hospital_mgt'); ?><span class="require-field">*</span></label>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="" class="form-control  validate[required,custom[onlyLetterNumber]]" type="text" maxlength="15" name="zip_code" value="">
									</div>
								</div>
							</div>
							<div class="header">
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="city_name" class="form-control validate[required,custom[city_state_country_validation]]" maxlength="50" type="text" name="home_city_name" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="home_state_name" class="form-control validate[custom[city_state_country_validation]]" maxlength="50" type="text" name="home_state_name" value="">
									</div>
									<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="country_name"><?php esc_html_e('Country', 'hospital_mgt'); ?></label>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="country_name" class="form-control validate[custom[city_state_country_validation]]" maxlength="50" type="text" name="country_name" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="mb-3 row">
									<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="zip_code"><?php esc_html_e('Zip Code', 'hospital_mgt'); ?><span class="require-field">*</span></label>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="zip_code" class="form-control  validate[required,custom[onlyLetterNumber]]" type="text" maxlength="15" name="home_zip_code" value="">
									</div>
								</div>
							</div>
							<div class="header">
							...
							<div class="form-group">
								<div class="mb-3 row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 has-feedback">
										<input id="doc_degree" class="form-control validate[required,custom[popup_category_validation]]" maxlength="500" type="text" name="doc_degree" value="">
									</div>
								</div>
							</div>
							<div class="header">
