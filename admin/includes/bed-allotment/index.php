										...
										<tbody>
											...
											?>
													<tr>
														...
														<td class="action"> 
														<a href="#" class="view_details_popup btn btn-default" id="<?php echo esc_attr( $retrieved_data->bed_allotment_id); ?>" type="<?php echo 'view_allotedbed';?>"><i class="fa fa-eye"> </i> <?php _e('View', 'hospital_mgt' ) ;?> </a>
