										 ...
										 ?>
											<tr>
												...
												<td class="action">
													...
													{?>
													<a href="#" class="show-discharge-popup btn btn-default" idtest="<?php echo esc_attr($retrieved_data->ID); ?>" >
													<i class="fa fa-ambulance"></i> <?php esc_html_e('Discharge', 'hospital_mgt');?></a>
													<?php }?>
													
													<?php if($doctordetail['patient_status'] == 'Discharged')
													{?>
													<a href="#" class="show-discharge_data-popup btn btn-default" idtest="<?php echo esc_attr($retrieved_data->ID); ?>" >
													...
													<a  href="#" class="show-popup btn btn-default" idtest="<?php echo esc_attr($retrieved_data->ID); ?>"><i class="fa fa-eye"></i> <?php esc_html_e('View Detail', 'hospital_mgt');?></a>
													<a  href="#" class="show-charges-popup btn btn-default" idtest="<?php echo esc_attr( $retrieved_data->ID); ?>">
