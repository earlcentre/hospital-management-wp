...
jQuery(document).ready(function($) {
	...
	if($active_tab == 'addaccountant')
	{
        ...
        <div class="panel-body">
			<form name="accountant_form" action="" method="post" class="form-horizontal" id="accountant_form" enctype="multipart/form-data"><!------- FORM START ----------->
						...
						<div class="offset-sm-2 col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<div id="upload_user_avatar_preview" >
								...
								if($edit) 
								{
									...
									{?>
										<img class="image_preview_css" alt="" src="<?php echo esc_url(get_option( 'hmgt_accountant_thumb' )) ?>">
									<?php }
									else
										{?>
