										...
										if(!empty($dignosis_data))
										{
											...
											<tr>
												...
												<?php
													...
													{
														echo '<a href="'.content_url().'/uploads/hospital_assets/'.$retrieved_data->attach_report.'" class="btn btn-default" target="_blank"><i class="fa fa-download"></i>  '. esc_html__( "Download", "hospital_mgt" ) .' </a>';
													}
													else 
													{
