	...
	<div id="main-wrapper"><!--- MAIN WRAPPER DIV START -->
	    <div class="panel panel-white"><!--- PANEL WHITE DIV START -->
			<div class="panel-body padding_0_res"><!--- PANEL BODY DIV START -->
				<h2>
				<?php esc_html_e( 'SupportStaff Access Right', 'hospital_mgt'); ?>
				</h2>
						...
						<div class="access_right_menucroll row access_right_padding">
							...
							<div class="row">
								...
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['SupportStaff']['virtual_appointment']['own_data'],1);?> value="1" name="virtual_appointment_own_data">
										</label>
									</div>
								</div>								
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['SupportStaff']['virtual_appointment']['view'],1);?> value="1" name="virtual_appointment_view">	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['SupportStaff']['virtual_appointment']['add'],1);?> value="1" name="virtual_appointment_add" >	              
										</label>
									</div>
								</div>
								<div class="col-sm-2 col-md-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['SupportStaff']['virtual_appointment']['edit'],1);?> value="1" name="virtual_appointment_edit" >	              
										</label>
									</div>
								</div>								
								<div class="col-sm-2 col-md-1">
									<div class="checkbox">
										<label>
											<input type="checkbox" <?php echo checked($access_right['SupportStaff']['virtual_appointment']['delete'],1);?> value="1" name="virtual_appointment_delete" >	              
										</label>
									</div>
								</div>
							</div>						
