										...
										<table id="ambulance_request" class="display" cellspacing="0" width="100%">
											...
											<tbody>
												...
												<tr>
													...
													<td class="action"> 
														<a href="#" class="view_details_popup btn btn-default" id="<?php echo esc_attr( $retrieved_data->amb_req_id); ?>" type="<?php echo 'view_ambulance_req';?>"><i class="fa fa-eye"> </i> <?php _e('View', 'hospital_mgt' ) ;?> </a>
										...
										$ambulance_data=$obj_ambulance->MJ_hmgt_get_all_ambulance();
										 if(!empty($ambulance_data))
										 {
											...
											<tr>
												...
												<td class="action"> 
													<a href="#" class="view_details_popup btn btn-default" id="<?php echo esc_attr( $retrieved_data->amb_id); ?>" type="<?php echo 'view_ambulance';?>"><i class="fa fa-eye"> </i> <?php _e('View', 'hospital_mgt' ) ;?> </a>
