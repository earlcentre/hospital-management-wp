        ...
        newLang: function(){
			...
			"func": function (field) {
			 ...
			 "alertText": "* תאריך לא תקין, חייב ליות בתבנית YYYY-MM-DD"
				...
				"onlyLetterAccentSp":{
                   // "regex": /^[a-z\u00C0-\u017F\ ]+$/i,
				    "regex":/^([A-Za-z\u0180-\u024F\u0100-\u017F\u0080-\u00FF\u00C0-\u00D6\u00D8-\u00f6\u00f8-\u00ff\u0000-\u007F\s]|[a-z\u00C0-\u017F\ ])+$/i,
                    "alertText": "* אותיות באנגלית בלבד"
                },
                "onlyLetterNumber": {
                   // "regex": /^[0-9a-zA-Z]+$/,
				    "regex": /^([A-Za-z\u0180-\u024F\u0100-\u017F\u0080-\u00FF\u00C0-\u00D6\u00D8-\u00f6\u00f8-\u00ff\u0000-\u007F\s]|[0-9a-zA-Z])+$/,
				...
				{
                     //"regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
				   "regex": /^([A-Za-z\u0180-\u024F\u0100-\u017F\u0080-\u00FF\u00C0-\u00D6\u00D8-\u00f6\u00f8-\u00ff\u0000-\u007F\s]|[^\x00-\x80]|[a-zA-Z\ \_\,\`\.\'\^\-])+$/,
				...
				{
                    //"regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
					"regex":/^([A-Za-z\u0180-\u024F\u0100-\u017F\u0080-\u00FF\u00C0-\u00D6\u00D8-\u00f6\u00f8-\u00ff\u0000-\u007F\s]|[0-9a-zA-Z\ \_\,\`\.\'\^])+$/,
