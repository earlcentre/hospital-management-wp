...
$p->add_field('return', home_url().'/?dashboard=user&page=invoice&action=success&half=yes'); // return URL after the transaction got over
...
$p->add_field('item_name_1','income');
...
//$p->add_field('entry_1', $_POST['income_entry'][0]);
...
$p->add_field('custom', $user_id."_".$invoiceid."_".$inv_amount."_".$_POST['income_entry'][0]);
$p->add_field('custom1',$_POST['income_entry'][0]);
$p->add_field('rm',2);
