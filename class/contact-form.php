...
class SPCF_ContactForm
{
	...
	public static function register_post_type() {
		register_post_type( self::post_type, array(
			'labels' => array(
				'name' => esc_html__( 'Contact Forms', 'spicy-form' ),
				'singular_name' => esc_html__( 'Contact Form', 'spicy-form' ) ),
			'rewrite' => false,
			'query_var' => false ) );
	}
...
public static function get_template( $args = '' ) {
		...
		$contact_form->title =
			( $title ? $title : esc_html__( 'Untitled', 'spicy-form' ) );
	...
	foreach ( $form_field['fields'] as $field ) {
						$frmbld_required_class = '';
							if ( $field['required'] === true ) {
								$required = '<span class="spcf_required">' . esc_html__('*', 'wcwm') . '</span>';
